...
j1Player::j1Player() : j1Module(), map_loaded(false)
{
	name.create("map");
}
...
iPoint j1Player::GetWorldPos(int x, int y) const
{
...
bool j1Player::LoadTilesetDetails(pugi::xml_node& tileset_node, TileSet* set)
{
	bool ret = true;
...
bool j1Player::LoadTilesetImage(pugi::xml_node& tileset_node, TileSet* set)
{
	bool ret = true;
...
bool j1Player::LoadLayer(pugi::xml_node& layernode, MapLayer* layer)
{
