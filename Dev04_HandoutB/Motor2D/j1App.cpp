...
bool j1App::Update()
{
	BROFILER_CATEGORY("Update App", Profiler::Color::Gold);
...
bool j1App::DoUpdate()
{
	BROFILER_CATEGORY("DoUpdate App", Profiler::Color::Gold);
	bool ret = true;
	p2List_item<j1Module*>* item;
	item = modules.start;
	j1Module* pModule = NULL;
...
{
	BROFILER_CATEGORY("PostUpdate App", Profiler::Color::Gold);
	bool ret = true;
	p2List_item<j1Module*>* item;
	j1Module* pModule = NULL;
