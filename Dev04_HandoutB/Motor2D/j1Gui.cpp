...
UI_element* j1Gui::CreateSlider(int x, int y, UI_Type type, SDL_Rect scrollbar, SDL_Rect button, SDL_Rect left_button, float width, UI_element* parent, j1Module* Observer)
{
	UI_Slider* slider = new UI_Slider(x, y, type, scrollbar, button, left_button, width, parent, Observer);
