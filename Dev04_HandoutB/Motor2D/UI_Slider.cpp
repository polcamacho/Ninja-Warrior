...
UI_Slider::UI_Slider(int x, int y, UI_Type type, SDL_Rect scrollbar, SDL_Rect button, UI_element* parent, j1Module* Observer) : UI_element(x, y, type, parent, Observer)
{
